...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<
      ['card', 'cash-on-delivery', 'paypal', 'stripe']
    > &
...
export interface ApiSettingSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    taxPercent: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSizeGuideSizeGuide extends Struct.SingleTypeSchema {
  collectionName: 'size_guide';
  info: {
